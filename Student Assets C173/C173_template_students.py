...
label_selected_doctor.place(relx=0.5, rely=0.3,anchor=W)
label_selected_IT=Label(root)
label_selected_IT.place(relx=0.5, rely=0.6,anchor=W)
label_selected_chemical=Label(root)
label_selected_chemical.place(relx=0.5, rely=0.9,anchor=W)
class parent():
    def __init__(self):
    ...
    def chemicalEngineer(chemical_engineer_name):
       company_list = ["Boeing","Westlake Chemical","Eastman","Honeywell"]
